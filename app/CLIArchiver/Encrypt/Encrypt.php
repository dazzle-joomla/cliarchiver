...
namespace Akeeba\CLIArchiver\Encrypt;

// Protection against direct access
use Akeeba\CLIArchiver\Encrypt\AesAdapter\AdapterInterface;
use Akeeba\CLIArchiver\Encrypt\AesAdapter\Mcrypt;
use Akeeba\CLIArchiver\Encrypt\AesAdapter\OpenSSL;
...
class Encrypt
{
	 ...
	 */
	public function AESEncryptCtr(string $plaintext, string $password, int $nBits): string
	{
	 ...
	 */
	public function Cipher(array $input, array $w): array
	{
	 ...
	 */
	public function KeyExpansion(array $key): array
	{
	 ...
	 */
	public function AESDecryptCtr(string $ciphertext, string $password, int $nBits): string
	{
		$blockSize = 16; // block size fixed at 16 bytes / 128 bits (Nb=4) for AES
	 ...
	 */
	public function AESEncryptCBC(string $plaintext, string $password): string
	{
	 ...
	 * @return  array
	 */
	public function getKeyDerivationParameters(): array
	{
		return array(
			'keySize'       => 16,
	 ...
	 */
	public function getStaticSaltExpandedKey(string $password): string
	{
		$params       = $this->getKeyDerivationParameters();
		$keySizeBytes = $params['keySize'];
		$algorithm    = $params['algorithm'];
	 ...
	 */
	public function pbkdf2(string $password, string $salt, string $algorithm = 'sha1', int $count = 1000, int $key_length = 16): string
	{
	 ...
	 */
	public function AESDecryptCBC(string $ciphertext, string $password): string
	{
		$adapter = $this->getAdapter();
	 ...
	 * @author  Nicholas K. Dionysopoulos
	 */
	public function expandKey(string $password): string
	{
	 ...
	 * @author  Nicholas K. Dionysopoulos
	 */
	function createTheWrongIV(string $password): string
	{
		static $ivs = array();
	 ...
	 * @return string
	 */
	public function getPbkdf2Algorithm(): string
	{
	 ...
	 * @return Encrypt
	 */
	public function setPbkdf2Algorithm(string $pbkdf2Algorithm): Encrypt
	{
	 ...
	 * @return int
	 */
	public function getPbkdf2Iterations(): int
	{
	 ...
	 * @return Encrypt
	 */
	public function setPbkdf2Iterations(int $pbkdf2Iterations): Encrypt
	{
	 ...
	 * @return int
	 */
	public function getPbkdf2UseStaticSalt(): int
	{
	 ...
	 * @return Encrypt
	 */
	public function setPbkdf2UseStaticSalt(int $pbkdf2UseStaticSalt): Encrypt
	{
	 ...
	 * @return string
	 */
	public function getPbkdf2StaticSalt(): string
	{
	 ...
	 * @return Encrypt
	 */
	public function setPbkdf2StaticSalt(string $pbkdf2StaticSalt): string
	{
